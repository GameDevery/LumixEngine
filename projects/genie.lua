...
if has_plugin("eeui") then
	project "eeui"
		...
		files { 
            "../src/eeui/**.h", 
            "../src/eeui/**.cpp", 
            "../src/eeui/eepp_support/**.hpp", 
            "../src/eeui/eepp_support/**.cpp", 
            "../src/eeui/eepp_support/scene/**.hpp", 
            "../src/eeui/eepp_support/scene/**.cpp", 
            "../src/eeui/eepp_support/graphics/**.hpp", 
            "../src/eeui/eepp_support/graphics/**.cpp", 
            "../src/eeui/eepp_support/thirdparty/PlusCallback/**.hpp",
            "../src/eeui/eepp_support/thirdparty/pugixml/**.hpp", 
            "../src/eeui/eepp_support/thirdparty/pugixml/**.cpp",
